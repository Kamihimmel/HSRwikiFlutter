                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      if (widget.characterinfo[widget.initialcharacter]
                                                              .info["light_cone"] !=
                                                          null)
                                                        Stack(
                                                          children: [
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: getImageComponent(
                                                              CharacterManager.getCharacter(cs.id).entity.eidolon[x].imageurl,
                                                              imageWrap: true,
                                                              placeholder: kTransparentImage,
                                                              width: 30),
                                                        ),
                                                ...
                                                for (int x = 0; x <= 3; x++) ...[
                                                  Column(
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Padding(
                                                            padding: const EdgeInsets.all(1.0),
                                                            child: getImageComponent(
                                                              CharacterManager.getCharacter(cs.id).entity.skilldata[x].imageurl,
                                                              imageWrap: true,
                                                              placeholder: kTransparentImage,
                                                              width: 40,),
                                                          ),
                                                      ...
                                                      Text(
                                                        "LV${cs.skillLevels[CharacterManager.getCharacter(cs.id).entity.skilldata[x].id]}",
                                                        style: const TextStyle(
                                                          //fontWeight: FontWeight.bold,
                                                          color: Colors.white,
                                                          fontSize: 15,
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Container(
                                                        child: Padding(
                                                          padding: const EdgeInsets.all(1.0),
                                                          child: getImageComponent(
                                                              CharacterManager.getCharacter(cs.id).elementType.icon,
                                                              imageWrap: true,
                                                              width: 50,
                                                              placeholder: kTransparentImage),
                                                        ),
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Container(
                                                        child: Padding(
                                                          padding: const EdgeInsets.all(1.0),
                                                          child: getImageComponent(
                                                            CharacterManager.getCharacter(cs.id).pathType.icon,
                                                            imageWrap: true,
                                                            width: 50,
                                                            placeholder: kTransparentImage),
                                                        ),
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Container(
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            "LV${cs.level} ${CharacterManager.getCharacter(cs.id).getName(getLanguageCode(context))}",
                                                            style: const TextStyle(
                                                              //fontWeight: FontWeight.bold,
                                                              color: Colors.white,
                                                              fontSize: 40,
                                                              ...
                                                              children: [
                                                                Padding(
                                                                  ...
                                                                  child: FadeInImage.memoryNetwork(
                                                                      ...
                                                                      image: urlendpoint +
                                                                          "starrailres/" +
                                                                          attributesfinal[x]['icon'],
                                                                      filterQuality: FilterQuality.medium),
                                                                ),
                                                                Text(
                                                                  (attributesfinal[x]['percent'])
                                                                      ? (attributesfinal[x]['value'] * 100)
                                                                              .toStringAsFixed(1) +
                                                                          "%"
                                                              ...
                                                              children: [
                                                                Padding(
                                                                  ...
                                                                  child: FadeInImage.memoryNetwork(
                                                                      ...
                                                                      image: urlendpoint +
                                                                          "starrailres/" +
                                                                          additionfinal[x]['icon'],
                                                                      filterQuality: FilterQuality.medium),
                                                                ),
                                                                Text(
                                                                  (additionfinal[x]['percent'])
                                                                      ? (additionfinal[x]['value'] * 100)
                                                                              .toStringAsFixed(1) +
                                                                          "%"
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                children: [
                                                  for (int x = 0;
                                                      x <
                                                          widget.characterinfo[widget.initialcharacter].info['relics']
                                                              .length;
                                                      x++) ...[
                                                    Padding(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                            ...
                                                            gradient: LinearGradient(
                                                              ...
                                                              colors: (widget.characterinfo[widget.initialcharacter]
                                                                          .info['relics'][x]['rarity'] ==
                                                                      5)
                                                                  ? [
                                                                      Colors.yellow.withOpacity(0.01),
                                                                      Colors.yellow.withOpacity(0.1)
                                                                    ]
                                                                  : (widget.characterinfo[widget.initialcharacter]
                                                                              .info['relics'][x]['rarity'] ==
                                                                          4)
                                                                      ? [
                                                          ...
                                                          children: [
                                                                ...
                                                                children: [
                                                                  FadeInImage.memoryNetwork(
                                                                      ...
                                                                      image: urlendpoint +
                                                                          "starrailres/" +
                                                                          widget.characterinfo[widget.initialcharacter]
                                                                              .info['relics'][x]['main_affix']['icon'],
                                                                      filterQuality: FilterQuality.medium),
                                                                  Text(
                                                                    (widget.characterinfo[widget.initialcharacter]
                                                                            .info['relics'][x]['main_affix']['percent'])
                                                                        ? (widget.characterinfo[widget.initialcharacter]
                                                                                            .info['relics'][x]
                                                                                        ['main_affix']['value'] *
                                                                                    100)
                                                                            ...
                                                                            "%"
                                                                        : widget.characterinfo[widget.initialcharacter]
                                                                            .info['relics'][x]['main_affix']['value']
                                                                            .toStringAsFixed(0),
                                                                    style: const TextStyle(
                                                                      //fontWeight: FontWeight.bold,
                                                                      color: Colors.white,
                                                                      ...
                                                                      Text(
                                                                        (widget.characterinfo[widget.initialcharacter]
                                                                            ...
                                                                            : widget
                                                                                ...
                                                                                .info['relics'][x]['sub_affix'][0]['value']
                                                                                .toStringAsFixed(0),
                                                                        style: const TextStyle(
                                                                          //fontWeight: FontWeight.bold,
                                                                          color: Colors.white,
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        (widget.characterinfo[widget.initialcharacter]
                                                                            ...
                                                                            : widget
                                                                                .characterinfo[widget.initialcharacter]
                                                                                .info['relics'][x]['sub_affix'][1]['value']
                                                                                .toStringAsFixed(0),
                                                                        style: const TextStyle(
                                                                          //fontWeight: FontWeight.bold,
                                                                          color: Colors.white,
                                                            ...
                                                            SizedBox(
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  if (widget.characterinfo[widget.initialcharacter]
                                                                          .info['relics'][x]['sub_affix'].length >
                                                                      2)
                                                                    Row(
                                                                      children: [
                                                                        Padding(
                                                                        ...
                                                                        Text(
                                                                          (widget.characterinfo[widget.initialcharacter]
                                                                              ...
                                                                              : widget
                                                                                  .characterinfo[widget.initialcharacter]
                                                                                  .info['relics'][x]['sub_affix'][2]['value']
                                                                                  .toStringAsFixed(0),
                                                                          style: const TextStyle(
                                                                            //fontWeight: FontWeight.bold,
                                                                            color: Colors.white,
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          (widget.characterinfo[widget.initialcharacter]
                                                                              ...
                                                                              : widget
                                                                                  .characterinfo[widget.initialcharacter]
                                                                                  .info['relics'][x]['sub_affix'][3]['value']
                                                                                  .toStringAsFixed(0),
                                                                          style: const TextStyle(
                                                                            //fontWeight: FontWeight.bold,
                                                                            color: Colors.white,
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () async {
                                      await screenshotController
                                        ...
                                        String fileName =
                                            widget.characterinfo[widget.initialcharacter].info['name'] + timeNow;
                                        if (kIsWeb || Platform.isWindows) {
                                          await FileSaver.instance.saveFile(
                                              name: fileName, bytes: image!, ext: 'png', mimeType: MimeType.png);
                                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                            duration: Duration(seconds: 3),
                                            content: Text("Saved".tr() +
                                                ((!kIsWeb && Platform.isWindows) ? " to Donwnload folder" : "")),
                                          ...
                                          XFile shareFile = XFile.fromData(image!,
                                              mimeType: MimeType.png.name, name: fileName, length: image.lengthInBytes);
                                          ShareResult shareResult = await Share.shareXFiles([shareFile],
                                              subject: fileName, text: 'Share Text'.tr());
                                          ...
                                          if (shareResult.status == ShareResultStatus.success) {
                                            ...
                                            if (shareResult.raw.contains('com.apple.UIKit.activity.SaveToCameraRoll')) {
                                              toastText = 'Saved'.tr();
                                            } else if (shareResult.raw
                                                .contains("com.apple.UIKit.activity.CopyToPasteboard")) {
                                              toastText = 'Copied'.tr();
                                            }
