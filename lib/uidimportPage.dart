                                    ...
                                    child: ElevatedButton(
                                      onPressed: (_uid.length == 9)
                                          ? () async {
                                              ...
                                              String url = kIsWeb ? "https://mohomoapi.yunlu18.net/${_uid}?lang=$langcode" : "https://api.mihomo.me/sr_info_parsed/${_uid}?lang=$langcode";
                                                  ...
                                                  children: [
                                                    Stack(
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: Padding(
                                                            padding: const EdgeInsets.all(8.0),
                                                            child: characterStats.lightconeId != ''
                                                                ? getImageComponent(
                                                            ...
                                                            child: Column(
                                                              children: [
                                                                Padding(
                                                                  ...
                                                                  child: Text(
                                                                    "S${characterStats.lightconeRank}",
                                                                    style: const TextStyle(
                                                                      //fontWeight: FontWeight.bold,
                                                                      color: Colors.white,
                                                                      fontSize: 25,
                                                    ...
                                                    if (relicSets[0] != '')
                                                      Container(
                                                        ...
                                                        child: Padding(
                                                          padding: const EdgeInsets.all(8.0),
                                                          child: getImageComponent(RelicManager.getRelic(relicSets[0]).entity.imageurl, placeholder: kTransparentImage),
                                                        ),
                                                      ),
                                                    SizedBox(
                                                      width: 5,
                                                      ...
                                                      children: [
                                                        if (relicSets[2] != '')
                                                          Container(
                                                            ...
                                                            child: Padding(
                                                              padding: const EdgeInsets.all(8.0),
                                                              child: getImageComponent(RelicManager.getRelic(relicSets[2]).entity.imageurl, placeholder: kTransparentImage),
                                                            ),
                                                          ),
                                                        if (relicSets[1] != '')
                                                          SizedBox(
                                                        ...
                                                        if (relicSets[1] != '')
                                                          Container(
                                                            ...
                                                            child: Padding(
                                                              padding: const EdgeInsets.all(8.0),
                                                              child: getImageComponent(RelicManager.getRelic(relicSets[1]).entity.imageurl, placeholder: kTransparentImage),
                                                            ),
                                                          ),
                                                      ],
                                                    ),
